...
Here the architecture of the new implementation, it is the same as the previous one, with the addiction of an extra layer: LevelDB cache.\\
\begin{minipage}{\linewidth}
\begin{center}
\vspace{9mm}
\includegraphics[height = 100mm]{./images/diagrams/architectureLevelDB.png} 
\vspace{6mm}
\captionof{figure}{Software architecture diagram using LevelDB\\}
